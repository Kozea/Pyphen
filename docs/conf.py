# pyphen documentation build configuration file.
...
htmlhelp_basename = 'pyphen2doc'

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [
    ('index', 'pyphen', 'pyphen Documentation',
